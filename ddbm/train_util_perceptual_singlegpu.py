    ...
    def validate_step(self, outputs, cond):
        with torch.cuda.amp.autocast():
            with torch.no_grad():
                ...
                x0_predicted, path, nfe, pred_x0, sigmas, _ = karras_sample(self.diffusion, self.ddp_model, cond["xT"], None, steps=10,mask=None,model_kwargs=cond,device=self.device,clip_denoised=True,sampler="heun",churn_step_ratio=0.0,eta=0.0,order=1,seed=42,)
